        ...
        v.findViewById(R.id.root_bank).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //    cashApply("1", amount);//1 银行卡
                    ...
                    //去填写银行卡
                    startFragment(InfoChangeFragment.getInstance(SP.getInfo(getActivity())));
                }
    ...
    private void cashApply(String type, String amount) {
        ...
        HttpUtil.getInstance(getActivity()).postForm(AppUrl.cashApply, map, new HttpUtil.ResultCallback() {
            ...
            public void onResponse(String s) throws IOException {
                ...
                showToast(json.msg);
                startFragment(CashGetStatusFragment.getInstance(true));
        ...
        HttpUtil.getInstance(getActivity())
                .postForm(AppUrl.smsGet, map, new HttpUtil.ResultCallback() {
                    ...
                    public void onResponse(String response)  {
                        ...
                        startFragment(CashGetSmsFragment.getInstance(mEdit.getText().toString().trim(),"3",phone,mRealname));
