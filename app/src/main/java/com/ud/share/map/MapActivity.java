        ...
        mBar.addRightTextButton("确定",R.id.topbar_right).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mPoiItem!=null){
                    ...
                    intent.putExtra("lat",mPoiItem.getLatLonPoint().getLatitude()+"");
                    intent.putExtra("lng",mPoiItem.getLatLonPoint().getLongitude()+"");
                    intent.putExtra("area",mPoiItem.getTitle()+"");
    ...
    AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (position != searchResultAdapter.getSelectedPosition()) {
                mPoiItem = (PoiItem) searchResultAdapter.getItem(position);

                LatLng curLatlng = new LatLng(mPoiItem.getLatLonPoint().getLatitude(), mPoiItem.getLatLonPoint().getLongitude());


                Log.d("map", "onItemClick: "+curLatlng.latitude+"//"+curLatlng.longitude+"//"+ mPoiItem.getTitle()+"//"+ mPoiItem.getAdCode());
