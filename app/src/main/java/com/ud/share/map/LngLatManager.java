 ...
 */
public class LngLatManager {
    private String TAG= LngLatManager.class.getSimpleName();
    private Context mContext;
    private AMapLocationClient mLocationClient;
    private AMapLocationClientOption mLocationOption;
    private OnLngLatChangeListener mOnLngLatChangeListener;
    public LngLatManager(Context context) {
        this.mContext=context;
    }

    public void setOnLngLatChangeListener(OnLngLatChangeListener onLngLatChangeListener) {
        mOnLngLatChangeListener = onLngLatChangeListener;
    }
        ...
        public void onLocationChanged(AMapLocation amapLocation) {
            if (amapLocation != null) {
                if (amapLocation.getErrorCode() == 0) {
                    ...
                    if (mOnLngLatChangeListener!=null){
                        mOnLngLatChangeListener.lnglatChange(amapLocation.getLongitude()+"",amapLocation.getLatitude()+"");
